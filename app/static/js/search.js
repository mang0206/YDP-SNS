const search_result_list = {"id": ["3", "4", "1", "2"]}
// const search_result_list = [{"id": "3"}, {"id": "1"}, {"id": "2"}]

const user_friend_list = {"id": "0"}

const request_friend_list = {"id": "2"}
...
//   } 
console.log(search_result_list.id)
console.log(user_friend_list.id)
